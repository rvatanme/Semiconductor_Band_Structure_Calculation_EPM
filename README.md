...
In general, U is a linear combination of atomic potential, U<sub>n</sub>(r-τ<sub>n</sub>), that can be expressed as a summation over all lattice translational R vectors: 
